...
function regionMove() {
    ...
    if (url.includes("/page=reports") || url.includes("/page=ajax2")) {
        ...
        // Only open the target region when there are 3 links in the happening (happens when the nation is dossed)
        // Undossed nations, or regions, will only show the target region and hence have only 2 links, but these are considered unimportant
